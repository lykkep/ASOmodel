...
% xlabll <- list(~italic(E[t]),~symbol(alpha),~italic(v)[prod],~italic(K)[dOTE],
%                 ~italic(k)[OTE%->%OCE],~italic(k)[T%->% Ø])
...
%            ylab=expression(italic('EC')[50]~' (nM)'),col=cbar[i],
%            ylim=c(1E-1,200),type='l',xaxt='n',yaxt='n',lwd=2,
%            xlab=expression(italic(K)[dOT]~'(nM)'),cex.lab=1)
