...
<<Figa,echo=T,fig=TRUE,include=FALSE,width=4,height=4>>=
...
@
The timetraces for the concentrations of $[O]$, $[T]$, $[OT]$, $[OTE]$, and $[E]$ are plotted:
<<Figb,echo=TRUE,fig=TRUE,include=FALSE,width=4,height=4>>=
SSvalue <- signif(last(solASO),3)
...
<<Figc,echo=TRUE,fig=TRUE,include=FALSE,width=4,height=4>>=
par(mar=c(3.2,3.4,0.1,0.1),bty='n',mgp=c(2,0.7,0),
    las=1,cex.lab=1.25)
...
<<Figd,echo=TRUE,fig=TRUE,include=FALSE,width=4,height=4>>=
par(mar=c(3.2,3.4,0.1,0.1),bty='n',mgp=c(2,0.7,0),
    las=1,cex.lab=1.25)
...
<<Fige, echo=TRUE,fig=TRUE,include=FALSE,width=4,height=4>>=
data(gapmers)
...
<<Figf,echo=TRUE,fig=TRUE,include=FALSE,width=4,height=4>>=
...
<<Figg, echo=TRUE,fig=TRUE,include=FALSE,width=4,height=4>>=
...
<<Figh, echo=TRUE,fig=TRUE,include=FALSE,width=4,height=4>>=
### We plot the data from Pedersen et al, 2013
dat.P <- dat[dat$Study=="Pedersen 2013",]
Plength <- dat.P$Oligo.length
